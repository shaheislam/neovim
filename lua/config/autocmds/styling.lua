...
local function apply_consistent_styles()
  ...
  vim.api.nvim_set_hl(0, "OpenCodeTransformAdd", { fg = "#9ece6a", bg = "#20362a", bold = true })
  vim.api.nvim_set_hl(0, "OpenCodeTransformDelete", { fg = "#f7768e", bg = "#3a2228", strikethrough = true })
