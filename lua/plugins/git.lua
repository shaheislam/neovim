...
return {
	...
	-- Flog for visual branch graph/history, bridged into Diffview for review
	{
		...
		keys = {
			{ "<leader>gG", function() require("git.flog").open_graph() end, desc = "Git graph" },
			{ "<leader>gV", function() require("git.flog").open_graph_split() end, desc = "Git graph split" },
			{ "<leader>gY", function() require("git.flog").open_current_file_graph() end, desc = "Git graph current file" },
			{ "<leader>gW", function() require("git.flog").open_current_file_graph_split() end, desc = "Git graph current file split" },
			{ "<leader>gY", function() require("git.flog").open_selected_lines_graph() end, mode = "v", desc = "Git graph selected lines" },
		},
		init = function()
