    ...
    config = function()
      require("octo").setup({
        ...
        mappings = {
          issue = {
            ...
            react_hooray = { lhs = "<leader>Orp", desc = "React party" },
          ...
          pull_request = {
            ...
            rebase_and_merge_pr = { lhs = "<leader>Opr", desc = "Rebase and merge" },
          ...
          review_diff = {
            ...
            add_review_suggestion = { lhs = "<leader>Osa", desc = "Add suggestion" },
            focus_files = { lhs = "<leader>Oe", desc = "Focus files" },
            toggle_files = { lhs = "<leader>Of", desc = "Toggle files" },
      ...
      vim.api.nvim_create_autocmd("FileType", {
        ...
        callback = function(ev)
          ...
          wk.add({
            { "<leader>Op", group = "PR ops", buffer = ev.buf },
            { "<leader>Oi", group = "issue ops", buffer = ev.buf },
            { "<leader>Ov", group = "review", buffer = ev.buf },
            { "<leader>Oa", group = "assignee", buffer = ev.buf },
            { "<leader>Ol", group = "label", buffer = ev.buf },
            { "<leader>Or", group = "reactions", buffer = ev.buf },
            { "<leader>Oc", group = "comment", buffer = ev.buf },
            { "<leader>Os", group = "suggestion", buffer = ev.buf },
            { "<leader>Ot", group = "toggle", buffer = ev.buf },
            { "<leader>Og", group = "goto", buffer = ev.buf },
          })
        end,
      })
